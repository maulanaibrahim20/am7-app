...
@push('css')
    <link rel="stylesheet" href="{{ url('/template') }}/vendor/libs/bs-stepper/bs-stepper.css" />
    <link rel="stylesheet" href="{{ url('/template') }}/vendor/css/pages/wizard-ex-checkout.css" />
    <link rel="stylesheet" href="{{ url('/template') }}/vendor/libs/rateyo/rateyo.css" />
@endpush
@section('content')
        ...
        <div class="bs-stepper-header m-auto border-0 py-5">
                ...
                <button type="button" class="step-trigger">
                    <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                            <use xlink:href="{{ url('/template') }}/svg/icons/wizard-checkout-cart.svg#wizardCart"></use>
                        </svg>
                    </span>
                ...
                <button type="button" class="step-trigger">
                    <span class="bs-stepper-icon">
                        <svg viewBox="0 0 54 54">
                            <use
                                xlink:href="{{ url('/template') }}/svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress">
                            </use>
                        </svg>
                    </span>
            ...
            <div class="step" data-target="#checkout-payment">
                <button type="button" class="step-trigger">
                    <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                            <use xlink:href="{{ url('/template') }}/svg/icons/wizard-checkout-payment.svg#wizardPayment">
                            </use>
                        </svg>
                    </span>
            ...
            <div class="step" data-target="#checkout-confirmation">
                <button type="button" class="step-trigger">
                    <span class="bs-stepper-icon">
                        <svg viewBox="0 0 58 54">
                            <use
                                xlink:href="{{ url('/template') }}/svg/icons/wizard-checkout-confirmation.svg#wizardConfirm">
                            </use>
                        </svg>
                    </span>
                        ...
                        <div class="col-xl-8 mb-3 mb-xl-0">
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item p-4">
                                    <div class="d-flex gap-3">
                                        <div class="flex-shrink-0 d-flex align-items-center">
                                            <img src="{{ url('/template') }}/img/products/1.png" alt="google home"
                                                class="w-px-100" />
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="row">
                                ...
                                <li class="list-group-item p-4">
                                    <div class="d-flex gap-3">
                                        <div class="flex-shrink-0 d-flex align-items-center">
                                            <img src="{{ url('/template') }}/img/products/2.png" alt="google home"
                                                class="w-px-100" />
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p class="me-3">
                                                        <a href="javascript:void(0)" class="text-body">Apple iPhone 11
                                                            (64GB, Black)</a>
                                                    </p>
                                                    <div class="text-muted mb-2 d-flex flex-wrap">
                                                        <span class="me-1">Sold by:</span>
                            ...
                            <div class="border rounded p-4 pb-3 mb-3">
                                ...
                                <ul class="list-unstyled">
                                    <li class="d-flex gap-3 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0">
                                                <a class="text-body" href="javascript:void(0)">Google - Google Home -
                                                    White</a>
                                            </p>
                                    ...
                                    <li class="d-flex gap-3 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0">
                                                <a class="text-body" href="javascript:void(0)">Apple iPhone 11 (64GB,
                                                    Black)</a>
                                            </p>
                                ...
                                <ul class="nav nav-pills mb-3" id="paymentTabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-gift-card-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="pills-gift-card" aria-selected="false">
                                            Gift Card
                                        </button>
                                    </li>
                                </ul>
                ...
                <div id="checkout-confirmation" class="content">
                    <div class="row mb-3">
                        <div class="col-12 col-lg-8 offset-lg-2 text-center mb-3">
                            ...
                            <p>
                                We sent an email to <a href="mailto:john.doe@example.com">john.doe@example.com</a> with
                                your
...
@endsection
@push('js')
    <script src="{{ url('/template') }}/vendor/libs/rateyo/rateyo.js"></script>
    <script src="{{ url('/template') }}/vendor/libs/cleavejs/cleave.js"></script>
    <script src="{{ url('/template') }}/vendor/libs/cleavejs/cleave-phone.js"></script>
    <script src="{{ url('/template') }}/vendor/libs/bs-stepper/bs-stepper.js"></script>
    <script src="{{ url('/template') }}/js/wizard-ex-checkout.js"></script>
    <script src="{{ url('/template') }}/js/modal-add-new-address.js"></script>
@endpush
