...
@section('page_nav_button')
    <a href="{{ route('master.supplier.create') }}" class="btn btn-primary d-none d-sm-inline-block" data-toggle="ajaxModal"
        data-title="Supplier | Add New">
        Add New
    </a>
@endsection
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <table id="dataTbl" class="table table-responsive" data-ajax="{{ route('master.supplier.getData') }}"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-data="contact_person">Contact Person</th>
                                <th data-data="phone">Phone</th>
                                <th data-data="email">Email</th>
                                <th data-data="address">Address</th>
                                <th data-data="lead_time_days">Lead Time (Days)</th>
