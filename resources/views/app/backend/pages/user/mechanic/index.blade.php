...
@section('breadcrumb', 'Mechanic Management')
@section('page_nav_button')
    <a href="{{ route('user.mechanic.create') }}" class="btn btn-primary d-none d-sm-inline-block" data-toggle="ajaxModal"
        data-title="Mechanic | Add New">
        Add New
    </a>
@endsection
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 text-end">
                        <a href="{{ route('user.mechanic.filter') }}" data-toggle="ajaxOffcanvas"
                            data-title="Admin | Add New" data-size="end" class="fas fa-filter text-secondary fs-4">
                        </a>
                    </div>
                    <table id="dataTbl" class="table table-responsive" data-ajax="{{ route('user.mechanic.getData') }}"
